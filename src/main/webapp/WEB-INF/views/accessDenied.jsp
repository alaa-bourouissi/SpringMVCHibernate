      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content">
            <div class="error_ex">
              <h1>404</h1>
              <h3>Opps, Dear <strong>${loggedinuser}</strong>,You are not authorized to access this page.	</h3>
              <p>We can not find the page you're looking for.</p>
              <a class="btn btn-warning btn-big"  href="/SpringMVCHibernateWithSpringSecurityExample/">Back to Home</a> </div>
          </div>
