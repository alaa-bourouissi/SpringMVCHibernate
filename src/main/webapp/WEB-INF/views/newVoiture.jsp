				...
				<div class="span12">
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							...
							<form:form method="POST" modelAttribute="voiture"
								...
								<div class="control-group">
									...
									<div class="controls">
										<form:input type="text" path="libelle" id="libelle"
											style="height:4%" />
									</div>
									<div class="has-error">
								...
								<div class="control-group">
									...
									<div class="controls">
										<form:select path="utilisateur" items="${utilisateurs}"
											itemValue="id" itemLabel="nom" style="margin-left: 4%;"></form:select>
									</div>
									<div class="has-error">
										<form:errors path="utilisateur" class="help-inline" />
									</div>
								</div>
