						...
						<div class="widget-content nopadding">
							...
							<form:form method="POST" modelAttribute="car"
								...
								<div class="control-group">
									...
									<div class="has-error">
										<form:errors path="registration" class="help-inline" />
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<form:select path="user" items="${utilisateurs}"
											itemValue="id" itemLabel="lastName" style="margin-left: 4%;"></form:select>
									</div>
									<div class="has-error">
