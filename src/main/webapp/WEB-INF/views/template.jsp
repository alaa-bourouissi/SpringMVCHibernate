...
<title>Insert title here</title>
	...
	<link href="<c:url value='/static/css/matrix-style.css' />" rel="stylesheet"></link>
	<link href="<c:url value='/static/css/matrix-media.css' />" rel="stylesheet"></link>
	<link href="<c:url value='/static/font-awesome/css/font-awesome.css' />" rel="stylesheet"></link>
	<link href="<c:url value='http://fonts.googleapis.com/css?family=Open+Sans:400,700,800' />" rel="stylesheet" type="text/css"></link>
